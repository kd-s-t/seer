...
# Policy for ECS tasks to access ECR
resource "aws_iam_role_policy" "ecs_task_ecr" {
  name = "${var.environment}-seer-ecs-task-ecr-policy"
...
# Policy for ECS tasks to access SSM Parameter Store
resource "aws_iam_role_policy" "ecs_task_ssm" {
  name = "${var.environment}-seer-ecs-task-ssm-policy"
  role = aws_iam_role.ecs_task.id
